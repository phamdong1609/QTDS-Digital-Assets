...
function initLibrary() { // Chính xác, không cần observer ở đây
    ...
    function renderArticles(articles) {
        gridContainer.innerHTML = articles.map(article => {
            ...
            return `
                <a href="${article.landing_page_url}" target="_blank" rel="noopener noreferrer" class="qtds-scroll-animate qtds-card qtds-article-card active">
